...
<%	
  ...
  if akaune="" then	akaune = Request.form("akaunz")
		...
		b3 = b3 & " from hasil.bil a,iabs.jabatan b where a.jabatan = b.kod and a.rowid = '"& akaune &"' "
		'response.Write("<br>")
		'response.Write(b3)
...
<table width="100%"  cellspacing="0" cellpadding="0" align="center">
   <tr>
     <td width="63%">&nbsp;</td>
     <td width="37%" valign="top">&nbsp;&nbsp;<%=rb("tkh")%></td>
   </tr>
   <tr>
     <td width="63%">&nbsp;</td>
...
<table width="100%"  cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td width="10%">&nbsp;</td>
    <td   colspan="2"><%if rb("nama") <> "" then%>&nbsp;<%=rb("nama")%><% else %>&nbsp;<% end if %></td>
  </tr>
  <tr> 
    <td width="10%">&nbsp;</td>
    <td colspan="2"><%if rb("alamat1") <> "" then%>&nbsp;<%=rb("alamat1")%><% else %>&nbsp;<% end if %></td>
  </tr>
  <tr> 
    <td width="10%">&nbsp;</td>
    <td colspan="2"><%if rb("alamat2") <> "" then%>&nbsp;<%=rb("alamat2")%><% else %>&nbsp;<% end if %></td>
  </tr>
  <tr> 
    <td width="10%">&nbsp;</td>
    <td colspan="2"><%if rb("alamat3") <> "" then%>&nbsp;<%=rb("alamat3")%><% else %>&nbsp;<% end if %></td>
  </tr>
  <tr> 
    <td width="10%">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
...
<table width="100%"  cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="27%" nowrap>&nbsp;Tarikh</td>
    <td width="1%">:</td>
    <td width="79%" nowrap>&nbsp;<%=rb("tkh1")%></td>
  </tr>
  <tr> 
    <td width="27%" nowrap>&nbsp;No Akaun </td>
    <td width="1%">:</td>
    <td width="79%" nowrap>&nbsp;<%=rb("no_akaun")%></td>
  </tr>
  <tr> 
    <td nowrap>&nbsp;No Rujukan </td>
    <td width="1%">:</td>
    <td width="79%" nowrap>&nbsp;<%=rb("perkara4")%> 
      <%'=objRs2("no_rujukan")%>
    </td>
  </tr>
  <tr> 
    ...
    <td width="1%">:</td>
    <td width="79%" nowrap>&nbsp;<%=rb("jab")%></td>
  </tr>
  <tr> 
    <td nowrap>&nbsp;Perihal</td>
    <td width="1%">:</td>
    <td width="79%" nowrap>&nbsp;<%=rb("perkara1")%></td>
  </tr>
  <tr> 
    <td nowrap>&nbsp;Perkara</td>
    <td width="1%">:</td>
    <td width="79%" nowrap>&nbsp;<%=rb("perkara")%>&nbsp;<%=sketer%></td>
  </tr>
  <tr> 
    <td nowrap>&nbsp;</td>
    <td width="1%">&nbsp;</td>
    <td width="79%" nowrap>&nbsp;<%=rb("no_rujukan")%></td>
  </tr>
  <tr> 
    <td nowrap>&nbsp;</td>
    <td width="1%">&nbsp;</td>
    <td width="79%" nowrap>&nbsp;<%=rb("perkara5")%></td>
  </tr>
  <tr> 
    <td nowrap>&nbsp;JUMLAH PERLU DIBAYAR</td>
    <td width="1%">:</td>
    <td width="79%" nowrap>&nbsp;RM<%=FormatNumber(rb("amaun"),2)%></td>
  </tr>
  <tr> 
    <td colspan="3" nowrap>&nbsp;Tarikh&nbsp;:&nbsp;<%=rb("tkh")%>&nbsp;&nbsp;SALINAN KOMPAUN</td>
  </tr>
  <tr> 
    <td nowrap>&nbsp;Disediakan</td>
    <td width="1%">:</td>
    <td width="79%" nowrap>&nbsp;<%=nop%>&nbsp;-&nbsp;<%=nama%></td>
  </tr>
</table>
<table width="100%" cellspacing="0" cellpadding="0"  align="center">
  <tr> 
...
<table cellspacing="0" cellpadding="0"  align="center" width="100%">
  <tr > 
    <td width="13%">&nbsp;</td>
    <td  width="88%" nowrap><%if rb("nama") <> "" then%><%=rb("nama")%><% else %>&nbsp;<% end if %></td>
  </tr>
  <tr> 
    <td valign="top">&nbsp;<%=rb("kategori")%></td>
    <td nowrap><%if rb("alamat1") <> "" then%><%=rb("alamat1")%><% else %>&nbsp;<% end if %></td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td nowrap><%if rb("alamat2") <> "" then%><%=rb("alamat2")%><% else %>&nbsp;<% end if %></td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td nowrap><%if rb("alamat3") <> "" then%><%=rb("alamat3")%><% else %>&nbsp;<% end if %></td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td nowrap="nowrap">No&nbsp;Rujukan&nbsp;:&nbsp;<%=rb("perkara4")%><%'=objRs2("no_rujukan")%></td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td nowrap="nowrap">Jumlah Perlu Dibayar &nbsp;:&nbsp;RM<%=FormatNumber(rb("amaun"),2)%></td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td nowrap><%=rb("no_akaun")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rb("tkh1")%>&nbsp;&nbsp;&nbsp;&nbsp;<%=rb("jabatan")%>&nbsp;&nbsp;-&nbsp;&nbsp;<%=rb("kategori")%></td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td nowrap>Disediakan :&nbsp;<%=nop%>&nbsp;&nbsp;-&nbsp;&nbsp;<%=nama%></td>
  </tr>
</table>	
<!--<table width="90%">
  <tr> 
