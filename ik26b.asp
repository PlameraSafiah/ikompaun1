...
<form method = "Post" action= "ha2126b.asp">
...
<tr>
          <td width="18%" bgcolor="#993333"><font face="Verdana" size="2" color="#FFFFFF"><b>&nbsp;Amaun Kompaun</b></font></td>
<td width="22%" bgcolor="lightgrey"><font face="Verdana" size="2"><b>&nbsp;RM</b>&nbsp;<%=FormatNumber(amaun,2)%></font></td>
          <td width="18%" bgcolor="#993333"><font face="Verdana" size="2" color="#FFFFFF"><b>&nbsp;Amaun 
            Bayar</b></font></td>
<td width="17%" bgcolor="lightgrey"><font face="Verdana" size="2"><b>&nbsp;RM</b>&nbsp;<%=FormatNumber(abayar,2)%></font></td>
</tr>
</table>
...
<% 
	...
	no_akaun = objRss("no_akaun")
%>
<table width ="100%" align="center">
<tr>
<td width="50%" align="right"><form method = "Post" action= "ha2111c.asp">
<input type="hidden" name="akaunz" value="<%=no_akaun%>">
