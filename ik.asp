...
'*********PERTANYAAN **************************************************************************
	...
	if mid(hkod,1,3) = "ik2" then kod_ik2 = "ik2"					
		if mid(hkod,1,4) = "ik21" then kod_ik21 = "ik21"    'jenis kesalahan
		...
		if mid(hkod,1,5) = "ik216" then kod_ik216 = "ik216" 	'laporan mengikut Parlimen
		if mid(hkod,1,5) = "ik217" then kod_ik217 = "ik217" 	'Pengeluar Notis Mengikut Jabatan
		if mid(hkod,1,5) = "ik218" then kod_ik218 = "ik218" 	'Laporan Keseluruhan Kompaun
		if mid(hkod,1,5) = "ik219" then kod_ik219 = "ik219" 	'Statistik Kompaun '08082018 - req by en.fikri (hari majlis)
		
'********* PENYELENGGARAAN KOD *****************************************************************************		
	if mid(hkod,1,3) = "ik4" then kod_ik4 = "ik4"					
		if mid(hkod,1,4) = "ik41" then kod_ik41 = "ik41"    'carian kompaun ic&brn
		if mid(hkod,1,4) = "ik42" then kod_ik42 = "ik42"    'carian kompaun XML
		if mid(hkod,1,4) = "ik43" then kod_ik43 = "ik43" 	'jenis tred 
		if mid(hkod,1,4) = "ik44" then kod_ik44 = "ik44"			'jenis kesalahan
		if mid(hkod,1,4) = "ik45" then kod_ik45 = "ik45"			'jenis ternakan
		''if mid(hkod,1,4) = "ik23" then kod_ik23 = "ik23"	'Jenis kesalahn & tahun
		''if mid(hkod,1,4) = "ik24" then kod_ik24 = "ik24"	'Kompaun Belum Bayar	
		if mid(hkod,1, 6) = "ik3333" then kod_ik3333 = "ik3333"  'Search kompaun - test run
		
		
		
'********* CARIAN KOMPAUN*****************************************************************************		 kena masukkan semula
	if mid(hkod,1,3) = "ik5" then kod_ik5 = "ik5"					
		if mid(hkod,1,4) = "ik41" then kod_ik41 = "ik41"    'carian kompaun ic&brn
		if mid(hkod,1,4) = "ik42" then kod_ik42 = "ik42"    'carian kompaun XML
...
'********* DAFTAR *****************************************************************************
	if mid(hkod,1,3) = "ik8" then kod_ik8 = "ik8"				'Daftar  
		...
		if mid(hkod,1,4) = "ik83" then kod_ik83 = "ik83"			'Penyelenggaraan Akta/UUK
		if mid(hkod,1,4) = "ik84" then kod_ik84 = "ik84"			'Penyelenggaraan Akta/UUK
		if mid(hkod,1,4) = "ik85" then kod_ik85 = "ik85"			'Sistem Kutipan MPSP
		if mid(hkod,1,4) = "ik86" then kod_ik86 = "ik86"			'Penyelenggaraan Kod Jadual Pembayaran
...
<ul id="nav" class="dropdown dropdown-horizontal">
    ...
    <% if kod_ik2 = "ik2" then 
	'-------menu laporan---------- %>
    <li><span class="dir">Laporan</span>
        <ul>
            ...
            <% '------------------hold dulu..mcm sama senarai kompaun-----------------------
           ...
           '' end if %>
            ...
            <% if kod_ik216 = "ik216" then %>
            <li><a href="ik216.asp?a=ik216.asp">Senarai Kompaun Mengikut Parlimen</a></li>
            <% end if %>
            
            
            <% if kod_ik217 = "ik217" then %>
            <li><a href="ik217.asp?a=ik217.asp">Pengeluar Notis Mengikut Jabatan</a></li>
            <% end if %>
            
            <% if kod_ik218 = "ik218" then %>
            <li><a href="ik218.asp?a=ik218.asp">Laporan Keseluruhan Kompaun</a></li>
            <% end if %>

	    <% if kod_ik219 = "ik219" then %>
            <li><a href="ik219.asp?a=ik219.asp">Laporan Kompaun >= 2 </a></li>
            <% end if %>
  ...
  <% if kod_ik4 = "ik4" then 
    ...
    <li><span class="dir">Penyelenggaraan Kod</span>
        <ul>
            ...
            <% end if %>
            <% if kod_ik45 = "ik45" then %>
            <li><a href="ik45.asp?a=ik45.asp">Jenis Ternakan</a></li>
            <% end if %>
    ...
    <% end if %>
         ...
         <% if kod_ik5 = "ik5" then 
	'-------Carian---------- %>
    <li><span class="dir">Carian Kompaun</span>
    <ul>
        <% 'if kod_ik41 = "ik41" then %>
         <!--   <li><a href="ik41.asp?a=ik41.asp">Carian </a></li>-->
            <%' end if %>
            
        <% if kod_ik42 = "ik42" then %>
            <li><a href="ik42.asp?a=ik42.asp">Carian </a></li>
            <% end if %>
    ...
    <li><span class="dir">Daftar</span>
        <ul>
            ...
            <% end if %>
            <% if kod_ik83 = "ik83" then %>
            <li><a href="ik83.asp?a=ik83.asp">Penyelenggaraan Akta/UUK</a></li>
            <% end if %>
            <% if kod_ik84 = "ik84" then %>
            <li><a href="ik84.asp?a=ik84.asp">Penyelenggaraan Akta/UUK 1</a></li>
            <% end if %>
            <% if kod_ik85 = "ik85" then %>
            <li><a href="ik85.asp?a=ik85.asp">Sistem Kutipan MPSP</a></li>
            <% end if %>
            <% if kod_ik86 = "ik86" then %>
            <li><a href="ik86.asp?a=ik86.asp">Penyelenggaraan Kod Jadual Pembayaran</a></li>
            <% end if %>
        </ul>
    </li>
    <% end if %>
        ...
        <ul>
            <li><a href="https://mpspnet.mpsp.gov.my/sistemnet.asp" onClick="return pasti()">Logout Sistem</a></li>
        </ul>
    </li>
</ul> 
<!--end menu-->  
