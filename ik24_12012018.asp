...
<%	Dim iPageSize,iPageCount,iPageCurrent,iRecordsShown
	...
	if proses = "Cari" or dtkh1 <> "" then
		...
		d = " select no_akaun, initcap(nama) nama, to_char(tkh_masuk,'dd/mm/yyyy') tkh_masuk,jabatan "
		d = d & " from hasil.bil "
...
<td width="40%" class="hd1">Nama</td>
<td width="15%" class="hd1">Tarikh</td>
<td width="25%" class="hd1">Jabatan</td>
</tr>
<%		bil = 0
		ctrz = 0
