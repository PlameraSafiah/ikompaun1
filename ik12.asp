...
<td class="hd">No Kompaun :</td><td>
          <input name="fnotis" type="text" id="ftkh" value="<%=fnotis%>" size="13" maxlength="12"> <%'tarikh notis tukaq jadi no kompaun -mimi %>
...
'******************************************************************
		...
		if fnotis <> "" then 
		d = d & " and no_akaun = '"& fnotis &"' "   ' mimi tambah by no notis - 6/8/2018
		end if 
