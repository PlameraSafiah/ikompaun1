...
<form method="POST" action="ik12n.asp">
<% 
...
if jab = "113" then
nama_pengarah = "DR SUJATHA A/P SARAVANAN"

sd = " select upper(b.nama) nama from  payroll.paymas b, hasil.kawalan a where b.no_pekerja = a.kesihatan_unit "	
		Set nmsd = objConn.Execute(sd)
	
		if not nmsd.eof then		nama_kunit = nmsd("nama") end if

end if

if jab = "112" then
nama_pengarah = "MOHD FAIDROL BIN MOHD RADZI"
jawatan = "PENGARAH PERLESENAN"
end if 

if jab = "105" then
nama_pengarah = "NOORHANIS BINTI NOORDIN"
jawatan = "PENGARAH BANGUNAN"
end if 

if jab = "103" then
nama_pengarah = "MOHD PUAD BIN HAMID"
jawatan = "PENGARAH PERKHIDMATAN PERBANDARAN"
end if 

if jab = "114" then
nama_pengarah = "NAZRI BIN ABDUL WAHAB"
jawatan = "PENGARAH DIREKTORAT PENGUATKUASAAN"
end if 
...
Pengarah Perkhidmatan Kesihatan,<%	else%>
<%=jawatan%>,
<%end if%>
